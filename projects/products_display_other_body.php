	  ...
	  <div class="row">
		<div class="col-sm-3">
		  <div class="panel panel-primary">
			<div class="panel-heading">1000 Series</div>
			<div class="panel-body">
				<img src="https://placehold.it/150x80?text=IMAGE" class="img-responsive" style="width:100%" alt="Image"><br>
				<center><a href="http://bradleys.senior-project-james-king.info/products_display_individual.php" class="btn btn-primary btn-lg">Set Viewing Appointment</a></center>
			</div>
		  </div>
		</div>
		<div class="col-sm-3">
